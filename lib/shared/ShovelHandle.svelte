...
// drawer's grab band (@ground-truth/getcache-onlinemap/lib/shared/shovelGrabBand).
//
...
// Both frames are imported rather than requested as "/mobileAssets/...".
// The bundler copies the bytes so they travel with this child; a
// leading-slash URL only resolves against a server that holds that file.
import shovelFistUrl from "../assets/mobileAssets/shovel-pullBarFist.webp";
import shovelBarUrl from "../assets/mobileAssets/shovel-pullBar.webp";
...
>
    ...
    <img
        ...
        src={dragging ? shovelFistUrl : shovelBarUrl}
        alt=""
        draggable="false"
    />
</div>
